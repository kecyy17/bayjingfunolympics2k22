...
export default function ContentDataGrid({contentData, handleEdit, handleDelete}) {
    ...
    { field: 'id', 
        ...
        align: "center",
        headerAlign: 'center',
        renderCell: (index) => <p> {index.api.getRowIndex(index.row.videoID) + 1 } </p>
    },
    {
      field: 'thumbnail',
      headerName: 'View',
      ...
      renderCell: (params) => {
        return(
            <div className='grid-action'>
                <div onClick={()=>handleEdit(params.row.videoID)}>
                    <EditOutlined />
                </div>
                <div onClick={()=>handleDelete(params.row.videoID)}>
                    <DeleteOutline />
                </div>
            </div>
        )
